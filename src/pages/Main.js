...
const Main = () => {
  ...
  return (
    <div id="products_list" className="w-full flex flex-col m-1">
        ...
        <div id="product_tags" className=" w-auto max-w-[550px] h-max py-1 mx-2 flex flex-row my-3 overflow-x-scroll tag  " >
            {
        ...
        <div id="mainbar__content" className="w-auto h-full mx-2 px-2 grid grid-flow-rows grid-cols-[repeat(auto-fit,minmax(14rem,1fr))]  scroll-smooth gap-[16px] justify-center justify-items-center border-[1px] border-red">
            {
