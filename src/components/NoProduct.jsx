...
const Product = ({id,product,noPrd=true}) => {
  ...
  return (
    ...
    <div id={"product_card"+id} className={(noPrd ? "w-[280px] ": " ") + " p-2 min-w-[280px] max-w-md flex flex-nowrap  flex-col gap-6 bg-white shadow-md border-t border-gray-200 rounded-md font-raleway "}>
