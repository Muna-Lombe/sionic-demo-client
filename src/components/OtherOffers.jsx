...
const OtherOffers = ({ children }) => {
  ...
  const handleScroll = (e, reverse) => {
    e.preventDefault();
    e.stopPropagation();
    const div1 = document.querySelector(".offered-products-grid .scroll-div-1")
  ...
  return (
    <div className="other-offered-products-wrapper relative w-full pt-10 px-6 flex flex-col gap-4">
      <p className="title py-2 text-2xl font-[arial font-bold ">{"Other offered products"}</p>
      <div className="products-wrapper  w-full flex flex-row border-y-2">
        ...
        <div className={"offered-products-grid py-2 w-full flex flex-col  gap-16 overflow-scroll tag"}>
          <>
