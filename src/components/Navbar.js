...
const Navbar = () => {
  ...
  return (
    ...
    <nav className=" w-full h-full flex justify-around gap-2 items-start  lg:items-center xl:items-center ">
      <div id="navbar_left__wrapper" className=" w-auto block md:block  lg:flex lg:flex-row xl:flex xl:flex-row justify-start items-center">
        ...
        <div id="search_field_wrapper" className="w-full lg:w-max xl:w-max flex justify-start items-center">
