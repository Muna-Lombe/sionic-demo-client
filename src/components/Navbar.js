...
const Navbar = () => {
  ...
  return (
    ...
    <nav className=" w-full h-full flex justify-center gap-2 items-start  lg:items-center xl:items-center ">
      <div id="navbar_left__wrapper" className=" w-full block md:block  lg:gap-6 lg:flex lg:flex-row xl:flex xl:flex-row justify-start items-center">
        ...
        <div id="search_field_wrapper" className="w-full lg:min-w-[16rem] xl:min-w-[16rem]  flex justify-center items-center">
