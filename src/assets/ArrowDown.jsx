...
const ArrowDown = ({size=20, handleClick}) => {
  return (
    ...
    // </svg>
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"  onClick={(e) => handleClick(e)} className={" arrow-down p-0 m-0 max-w-"+size+" h-max transition-transform rotate-90 z-30 cursor-pointer"}>
