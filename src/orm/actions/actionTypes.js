...
const constantsArr = ['UPDATE', 'UPDATE_ALL', 'REMOVE', 'ADD', 'CREATE', 'ADD_TO', 'REMOVE_FROM', 'REMOVE_ALL_OF', 'ASSIGN', 'FULFILLED', 'SET_LOADING', 'CLEAR_LOADING', 'FETCH_DATA', 'SELECT_PRODUCT', 'DELETE', 'ORDERED', 'IN_CART']
